...
class _ApiService implements ApiService {
  ...
  Future<List<AirportModel>> getAirports() async {
    ...
    final _result = await _dio
        .fetch<List<dynamic>>(_setStreamType<List<AirportModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<List<FlightModel>> searchFlights(
    ...
    const Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<List<dynamic>>(_setStreamType<List<FlightModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  @override
  Future<UserModel> getProfile(String bearerToken) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
  ...
  @override
  Future<List<PassengerModel>> getPassengers(String bearerToken) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Authorization': bearerToken};
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<List<dynamic>>(_setStreamType<List<PassengerModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    var value = _result.data!
        .map((dynamic i) => PassengerModel.fromJson(i as Map<String, dynamic>))
        .toList();
    return value;
  }
  ...
  @override
  Future<List<FlightModel>> getSavedFlights(String bearerToken) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Authorization': bearerToken};
    _headers.removeWhere((k, v) => v == null);
  ...
  Future<void> addSavedFlight(
    ...
    await _dio.fetch<void>(_setStreamType<void>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'user/saved-flights/add/${flightId}',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<void> deleteSavedFlight(
    ...
    await _dio.fetch<void>(_setStreamType<void>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'user/saved-flights/delete/${flightId}',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<void> checkSavedFlight(
    ...
    await _dio.fetch<void>(_setStreamType<void>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'user/check-saved-flight/${flightId}',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<ReservationModel> reserveFlight(
    String bearerToken,
    ReservationRequestBody reservation,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Authorization': bearerToken};
  ...
  @override
  Future<List<ReservationModel>> getReservations(String bearerToken) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Authorization': bearerToken};
    _headers.removeWhere((k, v) => v == null);
  ...
  Future<List<SeatModel>> getSeatsReserved(
    ...
    const Map<String, dynamic>? _data = null;
    final _result =
        await _dio.fetch<List<dynamic>>(_setStreamType<List<SeatModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
            .compose(
              _dio.options,
              'reservations/reserved-seats/${flightId}',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
